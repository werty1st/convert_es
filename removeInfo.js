 ...
 * node node_modules/.bin/elasticdump --input=http://localhost:9200/filebeat --output=$ --type=data --searchBody '{"query": { "match_all": {}}, "stored_fields": ["*"], "_source": true}' --limit 100 | node --max_old_space_size=140 removeInfo.js  --infile=- --outfile=data/out.js
 */
